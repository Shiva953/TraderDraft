...
export async function POST(request: Request) {
  try {
    console.log('🔵 [api/kol/user-holdings] POST endpoint called');
    ...
    console.log(`🔍 [api/kol/user-holdings] Fetching token holdings for: ${userPrivyWalletAddress}`);
    ...
    console.log(`📊 [api/kol/user-holdings] Found ${kolsWithTokens.length} KOLs with tokens`);
    ...
    console.log(`✅ [api/kol/user-holdings] Found ${holdings.length} token holdings`);
    ...
    console.error('❌ [api/kol/user-holdings] Error:', error);
    return NextResponse.json(
      {
        success: false,
