...
export async function GET(request: Request) {
  try {
    ...
    console.log(`🔍 [api/kol/random-images] Fetching ${count} random KOL images`);
    ...
    console.log(`✅ [api/kol/random-images] Returning ${shuffled.length} KOL images`);
    ...
    console.error('❌ [api/kol/random-images] Error:', error);
    return NextResponse.json(
      {
        success: false,
