...
const PackRevealSystem = () => {
  ...
  const [isLoadingPackCount, setIsLoadingPackCount] = useState(true) // Currently unused but kept for future use
      ...
      <AnimatePresence mode="wait">
        {currentStep === "banner" && (
          <motion.div
            ...
            className="h-full"
          >
            <PackRevealBanner onRevealClick={handleRevealClick} packCount={packCount} />
          </motion.div>
        )}
